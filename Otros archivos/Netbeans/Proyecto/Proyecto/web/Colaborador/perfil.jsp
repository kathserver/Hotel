    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                <h5 class="mb-3"><strong>Perfil de Usuario</strong></h5>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mt-1 mb-3 button-container bg-white border shadow-sm">
                            <div class="profile-bg p-5">
                                <img src="../assets/img/profile.jpg" height="125px" width="125px" class="rounded-circle shadow profile-img" />
                            </div>
                            <div class="profile-bio-main container-fluid">
                                <div class="row">
                                    <div class="col-md-5 offset-md-3 col-sm-12 offset-sm-0 col-12 bio-header">
                                        <h3 class="mt-4">Jonathan Clarke</h3>
                                        <span class="text-muted mt-0 bio-request">Colaborador</span>
                                    </div>
